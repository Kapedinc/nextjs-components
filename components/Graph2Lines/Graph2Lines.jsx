    ...
    <Graph2Lines1 className={props.className}>
      ...
      <Frame115>
        <Group1>
          ...
          <Line4></Line4>
          <Vector1
            src={`assets/images/Graph2lines_Vector_1.png`}
            loading="lazy"
            alt={'Vector 1'}
          />
          <Vector2
            src={`assets/images/Graph2lines_Vector_2.png`}
            loading="lazy"
            alt={'Vector 2'}
          />
          <Group2>
            ...
            <Frame110>
              ...
              <Frame111>
                <Frame109>
                  <Ellipse3
                    src={`assets/images/Graph2lines_Ellipse_3.png`}
                    loading="lazy"
                    alt={'Ellipse 3'}
                  />
              ...
              <Frame112>
                <Frame1091>
                  <Ellipse31
                    src={`assets/images/Graph2lines_Ellipse_3_1.png`}
                    loading="lazy"
                    alt={'Ellipse 3'}
                  />
            ...
            <Group>
              <Vector
                src={`assets/images/Graph2lines_Vector.png`}
                loading="lazy"
                alt={'Vector'}
              />
              <Vector3
                src={`assets/images/Graph2lines_Vector_3.png`}
                loading="lazy"
                alt={'Vector'}
              />
              <Vector4
                src={`assets/images/Graph2lines_Vector_4.png`}
                loading="lazy"
                alt={'Vector'}
              />
              <Vector5
                src={`assets/images/Graph2lines_Vector_5.png`}
                loading="lazy"
                alt={'Vector'}
              />
              <Vector6
                src={`assets/images/Graph2lines_Vector_6.png`}
                loading="lazy"
                alt={'Vector'}
              />
            </Group>
